...
from oscar.apps.search.forms import FacetedSearchForm


RESULTS_PER_PAGE = getattr(settings, 'HAYSTACK_SEARCH_RESULTS_PER_PAGE', 20)

# see https://github.com/toastdriven/django-haystack/pull/826
...
class FacetedSearchMixin(SearchMixin):
    ...
    def build_form(self, form_kwargs=None):
        ...
        return super(FacetedSearchMixin, self).build_form(form_kwargs)
